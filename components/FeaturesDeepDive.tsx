...
const overlayStates = [
  ...
  { state: "Listening", eyes: "Enlarged, alert, rhythmic pulsing", color: "#8b5cf6" },
  { state: "Thinking", eyes: "Upward offset, tilted, nervous jitter", color: "#d946ef" },
  { state: "Speaking", eyes: "Large, expressive, talking animation", color: "#a78bfa" },
  { state: "Capturing", eyes: "Focused, scanning mode", color: "#9333ea" },
  { state: "Live", eyes: "Gemini Live voice mode, real-time streaming", color: "#c084fc" },
];
  ...
  return (
    <section className="relative py-24 md:py-32">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        {/* Feature grid — subcard-hover for premium GPU expand */}
          ...
          {featureBlocks.map((feat, i) => (
            <ScrollReveal key={feat.title} delay={i * 0.1}>
              <motion.div
                ...
                className="glass-card p-6 h-full group cursor-default border border-white/[0.06] hover:border-violet-500/20 transition-colors duration-300"
        ...
        <ScrollReveal>
          <div className="glass-card p-8 md:p-12 subcard-hover">
                ...
                <div className="space-y-2">
                  {overlayStates.map((s, i) => (
                    <ScrollReveal key={s.state} delay={i * 0.08} direction="right" distance={20}>
                      <div className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.02] border border-white/[0.04] hover:border-violet-500/20 hover:bg-violet-500/[0.03] transition-all duration-200 cursor-default">
                        <div
