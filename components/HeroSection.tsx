...
export default function HeroSection() {
  return (
    ...
    >
      {/* MagicRings WebGL background — violet/fuchsia palette */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-center">
        ...
        >
          <span className="gradient-text" style={{ fontFamily: "var(--font-rostex), system-ui, sans-serif" }}>Kaaya</span>
        </motion.h1>
        ...
        >
          ...
          <a
            href="#features"
            className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full text-sm font-semibold text-white/80 border border-white/10 hover:border-violet-500/30 hover:bg-violet-500/5 transition-all duration-300"
          >
            Explore Features
